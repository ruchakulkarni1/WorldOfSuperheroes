   ...
   return(
    ...
    <div class="row">
        <div class="col-4 author">
            ...
            <h4><a class="linkStyle" href="https://github.com/ruchakulkarni1">GitHub</a></h4>
        </div>
        <div class="col-4 author">
            <h4 class="authorName">Siri Koduru</h4>
            <img src="./icons/woman2.png" alt="clipart2" class="aboutIcon"/>
            <h4><a class="linkStyle" href="https://github.com/sirikoduru24">GitHub</a></h4>
        </div>
        <div class="col-4 author">
            <h4 class="authorName">Larrisa Carvalho</h4>
            <img src="./icons/woman3.png" alt="clipart3" class="aboutIcon"/>
            <h4><a class="linkStyle" href="https://github.com/larrisacarvalho">GitHub</a></h4>
        </div>
    </div>
    </div>
